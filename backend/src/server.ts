...
logger.info(
  {
    ...
    aiProvider: envDiagnostics.aiProvider,
    rawAiProvider: envDiagnostics.rawAiProvider,
    kimiBaseUrl: envDiagnostics.kimiBaseUrl,
    kimiModel: envDiagnostics.kimiModel,
    ollamaBaseUrl: envDiagnostics.ollamaBaseUrl,
    ollamaModel: envDiagnostics.ollamaModel,
    ollamaVisionModel: envDiagnostics.ollamaVisionModel,
    ...
    moonshotApiKeyPreview: envDiagnostics.moonshotApiKeyPreview,
